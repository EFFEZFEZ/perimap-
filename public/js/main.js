...
// ICÔNES SVG
const ICONS = {
    BUS: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M7 3h10a3 3 0 0 1 3 3v11a3 3 0 0 1-3 3v1.25c0 .97-.78 1.75-1.75 1.75H15a1.75 1.75 0 0 1-1.75-1.75h-2.5A1.75 1.75 0 0 1 9 21.25V20a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3Zm-1 5v4h12V8H6Zm0 7.5a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0Zm10.5 0a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0Z"/></svg>`,
    busSmall: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M7 3h10a3 3 0 0 1 3 3v11a3 3 0 0 1-3 3v1.25c0 .97-.78 1.75-1.75 1.75H15a1.75 1.75 0 0 1-1.75-1.75h-2.5A1.75 1.75 0 0 1 9 21.25V20a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3Zm-1 5v4h12V8H6Zm0 7.5a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0Zm10.5 0a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0Z"/></svg>`,
    ...
    BICYCLE: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><circle cx="6" cy="17" r="3.4"/><circle cx="18" cy="17" r="3.4"/><path d="M9.3 9.2c.4-.9 1.3-1.7 2.5-1.7h2.5c.7 0 1.3.4 1.6 1l.6 1.5H20a1.25 1.25 0 1 1 0 2.5h-2.2l1 2.8A3.4 3.4 0 0 0 18 13.4l-1.7-3.5H14l-.9 2.6A3.4 3.4 0 0 1 6 15c0-.2 0-.4.1-.6h2.2l1.4-2.8-1.6-2.1a1.25 1.25 0 0 1 1.2-2.3Z"/></svg>`,
    WALK: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.5a2.3 2.3 0 1 1 0 4.6 2.3 2.3 0 0 1 0-4.6Zm-2.4 5.9a1.5 1.5 0 0 1 2-.6l2.4 1.3c.4.2.7.5.8.9l.6 2.2 2.5.5a1.4 1.4 0 0 1-.5 2.7l-3.3-.6-1.2 3.3 2.2 3.6a1.4 1.4 0 0 1-2.4 1.4L12 18.8l-2 3.7a1.4 1.4 0 0 1-2.5-1.2l2.5-5.1-.9-3.4-1.2 1a1.4 1.4 0 0 1-1.9-2.1Z"/></svg>`,
