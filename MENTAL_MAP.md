**Offline-ready** : Service Worker v519 (cache versionné, purge, stratégies cache-first/stale-revalidate/network-first, gestion messages, notifications push, enregistrement centralisé via app.js) + GTFS local
